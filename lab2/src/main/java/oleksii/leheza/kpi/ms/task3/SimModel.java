...
public class SimModel {
    public static void main(String[] args) {
        ...
        Process p3 = createProcess(2.0, null, "PROCESS_3", "exp", 5);
        Process p2 = createProcess(2.0, p3, "PROCESS_2", "exp", 5);
        Process p1 = createProcess(2.0, p2, "PROCESS_1", "exp", 5);
        Create c = create(5.0, p1, "CREATOR", "exp");
    ...
    private static Process createProcess(double delay, Element nextElement, String name, String distribution, int maxQueue) {
